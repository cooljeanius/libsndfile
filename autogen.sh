...
if test ! -f $fprecommit ; then
	...
	if test ! -d .git/hooks ; then
		...
		mkdir -p .git/hooks
		echo "Installing git pre-commit hook for real now ... "
	fi
...
foobar
	...
	echo
	echo "Done. Now you can type \"./configure\" and then \"make\" and then \"make install\" to install this project manually."
	echo
fi
